    ...
    <div className="flex items-center justify-between mb-4">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          disabled={isExportDisabled}
          className="px-4 py-2 bg-gradient-to-r from-pink-600 to-rose-600 text-white font-semibold rounded-xl hover:from-pink-500 hover:to-rose-500 disabled:from-gray-600 disabled:to-gray-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all transform hover:scale-105 active:scale-95 shadow-lg flex items-center gap-2 text-sm"
          title="파티 목록을 이미지로 클립보드에 복사합니다"
        >
          <svg
            className="w-4 h-4"
            fill="none"
